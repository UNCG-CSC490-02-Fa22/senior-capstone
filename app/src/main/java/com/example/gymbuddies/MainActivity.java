...
import com.example.gymbuddies.UserCardArrayAdapter;
import com.example.gymbuddies.UserCard;
import com.example.gymbuddies.Matches.MatchesActivity;
...
//        arrayAdapter.notifyDataSetChanged();
        ...
        flingContainer.setFlingListener(new SwipeFlingAdapterView.onFlingListener() {
            ...
            public void onLeftCardExit(Object dataObject) {
                ...
                UserCard obj = (UserCard) dataObject;
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                if (dataSnapshot.child("sex").getValue() != null) {
                    if (dataSnapshot.exists() && !dataSnapshot.child("connections").child("nope").hasChild(currentUId) && !dataSnapshot.child("connections").child("yeps").hasChild(currentUId) && dataSnapshot.child("sex").getValue().toString().equals(oppositeUserSex)) {
                        ...
                        UserCard item = new UserCard(dataSnapshot.getKey(), dataSnapshot.child("name").getValue().toString(), profileImageUrl);
                        rowItems.add(item);
                        arrayAdapter.notifyDataSetChanged();
                    }
                }
